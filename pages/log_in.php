...
if ($was=="Adduser"){
                     ...
                     <h1 class="edit-page-titel">Add Members Page</h1>
                        ...
                        <div class="check-boxes">
                           <div class="form-check mb-2">
                              <input class="form-check-input" type="radio" name="who" id="admin" value="admin" checked>
                              <label class="form-check-label" for="admin">Admin</label>
                           </div>
                           <div class="form-check me-2">
                              <input class="form-check-input mb-3" type="radio" name="who" id="user" value="user">
                     ...
                     foreach($admins as $key => $value){
                        if($_POST['stand_user']==$value["id"]){
                           $choosed=$value['username'];
                           break;
                        }else{ $choosed="No One";}
                     }
                     //first way => to insiste
                     //  if($_POST['who']==="admin"&&$_POST['stand_user']==="none"){$groupid=1;$working_under=0;}

                     //  else if($_POST['who']==="user"&&$_POST['stand_user']!=="none"){$groupid=0;$working_under=intval($_POST['stand_user']);}

                     //  else if($_POST['who']==="user"&&$_POST['stand_user']==="none"){$error_add_account[]="You Must Choose An Admin";}
                     ...
                     elseif($_POST['who']==="admin"&&$_POST['stand_user']!=="none"){$groupid=1;$working_under=0;}
